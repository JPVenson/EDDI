...
namespace Utilities.Unity
{
	public static class IoC
	{
		...
		public static object RegisterInstance(object instance, Type impl = null, string name = null)
		{
			if (impl == null)
			{
				impl = instance.GetType();
			}
			Container.RegisterInstance(impl, name, instance, new SingletonLifetimeManager());
