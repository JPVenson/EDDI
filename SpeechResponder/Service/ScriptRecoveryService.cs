...
using EddiSpeechResponder.ViewModel;
...
namespace EddiSpeechResponder.Service
{
	public class ScriptRecoveryService
	{
		...
		private EditScriptDialogViewModel _scriptor;
		...
		/// </summary>
		public void BeginScriptRecovery(EditScriptDialogViewModel scriptor)
		{
			_scriptor = scriptor;
			...
			_scriptor.PropertyChanged += _scriptWindow_PropertyChanged;
		}

		private void _scriptWindow_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
		{
			if (e.PropertyName == nameof(EditScriptDialogViewModel.ScriptValue))
			{
				//the script value has changed. Begin the callguard and save the script value
				BeginScriptSave(_scriptor);
			}
		}

		private void BeginScriptSave(EditScriptDialogViewModel window)
		{
		...
		public void InvokeSave(EditScriptDialogViewModel window)
		{
			SaveRecoveryScript(window.ScriptValue,
				window.ScriptName,
				window.ScriptDescription,
